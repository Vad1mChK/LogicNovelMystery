                ...
                <form id="facts-form">
                    ...
                    <div className="statement">
                        <input
                            ...
                            onChange={handleCheckboxChange}
                        />
                        <label htmlFor="fact2">capture(X, Y) :- virus(X, Y)</label>
                    </div>
                    <div className="statement">
                        <input
                            type="checkbox"
                    ...
                    <div className="statement">
                        <input
                            ...
                            onChange={handleCheckboxChange}
                        />
                        <label htmlFor="fact4">capture(X, Y) :- virus(X, Z), virus(Z, Y)</label>
                    </div>
                    <div className="btn-container">
                        <button type="button" className="btn" onClick={checkAnswers}>Check</button>
                    </div>
                </form>
                <p id="result" style={{ marginTop: '20px', fontWeight: 'bold' }}>{result}</p>
            </div>
        </div>
    );
};
