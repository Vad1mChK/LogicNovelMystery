...
const Location3_vicky = () => {
	...
	switch (clickCount) {
		case 1:
			textContent = (
				<p>
					Уааа, ааааа...Зачем вы сразу драться, мисс?! Я всего лишь
					робот модель R3, я робот-помощник человека. А вы меня сразу
					бьете!
				</p>
			);
		...
		case 2:
			textContent = (
				<p>
					С ума сойти!Офонареть можно!Этот робот такой эмоциональный!
					Ты прости, я не хотела. Зачем ты сам меня схватил за ногу?
				</p>
			);
		...
		case 3:
			textContent = (
				<p>
					Я лишь хотел уберечь вас мисс. В этих местах ходить
					запрещено!
				</p>
			);
			overlayTextContent = 'Робот';
